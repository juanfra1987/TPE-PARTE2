...
<div class="alineacion">
    <body>
        ...
        <aside>
        {include file="../template/tablaEspecialidades.tpl"}
        {if ($logueado)}
            {include file="../template/formAgregarEspecialidad.tpl"}
            {if isset($consultaEsp)}
                {include file="../template/modificacionDatosEspec.tpl"}
            {/if}
        {/if}
        </aside>
        <footer>
